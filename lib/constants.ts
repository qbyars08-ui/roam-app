...
export const DESTINATIONS: Destination[] = [
  ...
  { label: 'Porto', emoji: '', country: 'PT', hook: 'Wine, tiles, and zero pretension', photoQuery: 'Ribeira Porto Portugal', category: 'food', unsplashUrl: 'https://images.unsplash.com/photo-1555881400-69169e0ec7b3?w=800&q=85', dailyCost: 70, trendScore: 77, bestMonths: [5, 6, 9, 10] },
  ...
  { label: 'Dubrovnik', emoji: '', country: 'HR', hook: 'Go in September. Avoid the cruise ship crowds.', photoQuery: 'Dubrovnik old town walls Croatia', category: 'couples', unsplashUrl: 'https://images.unsplash.com/photo-1555990538-1085d1e45381?w=800&q=85', dailyCost: 95, trendScore: 73, bestMonths: [5, 6, 9, 10] },
  ...
  { label: 'Cartagena', emoji: '', country: 'CO', hook: 'Pastel walls, Caribbean soul, $3 ceviche', photoQuery: 'Cartagena old city Colombia', category: 'beaches', unsplashUrl: 'https://images.unsplash.com/photo-1583531172005-814048382827?w=800&q=85', dailyCost: 55, trendScore: 71, bestMonths: [12, 1, 2, 3] },
  ...
  { label: 'Queenstown', emoji: '', country: 'NZ', hook: 'Bungee jump before breakfast. Why not.', photoQuery: 'Queenstown New Zealand mountains', category: 'mountains', unsplashUrl: 'https://images.unsplash.com/photo-1589871973318-9ca1258faa1d?w=800&q=85', dailyCost: 130, trendScore: 67, bestMonths: [12, 1, 2, 6, 7, 8] },
];

export const HIDDEN_DESTINATIONS: Destination[] = [
  { label: 'Azores', emoji: '', country: 'PT', hook: 'Nine islands of volcanic wonder', photoQuery: 'Sete Cidades Azores Portugal', category: 'adventure', unsplashUrl: 'https://images.unsplash.com/photo-1565073182887-6bcefbe225b1?w=800&q=85', dailyCost: 90, trendScore: 65, bestMonths: [5, 6, 7, 8, 9] },
  { label: 'Ljubljana', emoji: '', country: 'SI', hook: 'Dragons, castles, and green soul', photoQuery: 'Ljubljana castle Slovenia', category: 'cities', unsplashUrl: 'https://images.unsplash.com/photo-1569396116180-210c182bedb8?w=800&q=85', dailyCost: 70, trendScore: 62, bestMonths: [5, 6, 9, 10] },
  { label: "Colombia's Coffee Axis", emoji: '', country: 'CO', hook: 'Where your morning brew was born', photoQuery: 'Coffee farm Colombia Eje Cafetero', category: 'adventure', unsplashUrl: 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&q=85', dailyCost: 45, trendScore: 60, bestMonths: [1, 2, 3, 12] },
  { label: 'Santorini', emoji: '', country: 'GR', hook: 'White caves, blue domes, golden sunsets', photoQuery: 'Oia Santorini Greece sunset', category: 'couples', unsplashUrl: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800&q=85', dailyCost: 140, trendScore: 70, bestMonths: [5, 6, 9, 10] },
  { label: 'Siem Reap', emoji: '', country: 'KH', hook: 'Temples older than time itself', photoQuery: 'Angkor Wat Cambodia sunrise', category: 'adventure', unsplashUrl: 'https://images.unsplash.com/photo-1508159452718-d22d04ec851d?w=800&q=85', dailyCost: 40, trendScore: 68, bestMonths: [11, 12, 1, 2] },
];
