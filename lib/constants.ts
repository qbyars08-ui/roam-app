...
export const HIDDEN_DESTINATIONS: Destination[] = [
  ...
  { label: 'Siem Reap', emoji: '', country: 'KH', hook: 'Temples older than time itself', photoQuery: 'Angkor Wat Cambodia sunrise', category: 'adventure', unsplashUrl: 'https://images.unsplash.com/photo-1569683795645-b62e50fbf103?w=800&q=85', dailyCost: 40, trendScore: 68, bestMonths: [11, 12, 1, 2] },
];
