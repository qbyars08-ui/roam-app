...
const en = {
  ...
  people: {
    title: 'People',
    headerSub: 'Your travel crew is already out there',
    heroTitle: "Meet the people going where you're going",
    heroSub: 'Tell us where. We show you who else is heading there, when they leave, and what they care about.',
    activeTravelers: 'Active travelers',
    destinations: 'Destinations',
    groupsForming: 'Groups forming',
    openGroups: 'Open groups',
    openGroupsSub: 'Trips forming now \u2014 one spot could be yours',
    matchedTravelers: 'Matched travelers',
    matchedTravelersSub: 'Same destination. Same window. Similar energy.',
    connect: 'Connect',
    completeProfileCta: 'Add your destinations to see who else is going.',
    setUpProfile: 'Set up your travel profile',
    going: '{{count}} going',
  ...
  generate: {
    ...
    noTripsSub: "Pick somewhere. 30 seconds. You\u2019ll have a full plan before anyone talks you out of it.",
    howDoYouWant: 'How do you want to plan?',
    quickMode: 'Quick',
