...
const de: TranslationKeys = {
  ...
  discover: {
    ...
    dailyCost: '{{cost}}\u20ac/Tag',
    trending: 'trending',
    perfectTiming: 'Perfektes Timing',
  },
  ...
  people: {
    title: 'Community',
    headerSub: 'Deine Reisecrew ist schon da drau\u00dfen',
    heroTitle: 'Triff die Leute, die dahin fahren, wo du hinwillst',
    heroSub: 'Sag uns wohin. Wir zeigen dir, wer sonst noch hinfährt, wann sie fahren und was ihnen wichtig ist.',
    activeTravelers: 'Aktive Reisende',
    destinations: 'Destinationen',
    groupsForming: 'Gruppen in Planung',
    openGroups: 'Offene Gruppen',
    openGroupsSub: 'Trips die sich gerade formen \u2014 vielleicht ist ein Platz f\u00fcr dich dabei',
    matchedTravelers: 'Gematchte Reisende',
    matchedTravelersSub: 'Gleicher Ort. Gleicher Zeitraum. Gleiche Energie.',
    connect: 'Vernetzen',
    completeProfileCta: 'F\u00fcge deine Ziele hinzu, um zu sehen, wer noch hinfährt.',
    setUpProfile: 'Reiseprofil einrichten',
    going: '{{count}} dabei',
  ...
  generate: {
    title: 'Trip planen',
    noTripsTitle: 'Noch keine Trips.',
    noTripsSub: 'Such dir irgendwo aus. 30 Sekunden. Du hast einen Plan, bevor dich jemand davon abhalten kann.',
    howDoYouWant: 'Wie willst du planen?',
    quickMode: 'Schnell',
