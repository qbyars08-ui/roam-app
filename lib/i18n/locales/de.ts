...
const de: TranslationKeys = {
  ...
  flights: {
    ...
    heroTitle: 'Finde deinen Flug.',
    heroSub: 'Wir suchen auf Skyscanner \u2014 du kriegst immer den besten Preis.',
    fromPlaceholder: 'Von (Stadt oder Flughafen)',
    toPlaceholder: 'Nach (Stadt oder Flughafen)',
    depart: 'ABFLUG',
    returnLabel: 'R\u00dcCKFLUG',
    searchSkyscanner: 'Auf Skyscanner suchen',
    popularRoutes: 'Beliebte Routen',
    popularRoutesSub: 'Die Fl\u00fcge, die gerade alle buchen',
    routeSearch: 'Suchen',
    routeLabel: '{{from}} nach {{to}}',
    bestTimeToFly: 'Die beste Reisezeit',
    bestTimeSub: 'Perfektes Wetter, weniger Trubel, tolles Timing',
    disclaimer: 'ROAM erh\u00e4lt eine kleine Provision, wenn du \u00fcber Skyscanner buchst. So bleibt die App kostenlos.',
  },
  ...
  prep: {
    ...
    sectionSchedule: 'Tagesplan',
    sectionOverview: '\u00dcberblick',
    sectionCurrency: 'W\u00e4hrung',
    sectionCulture: 'Kultur',
    sectionConnectivity: 'SIM & WLAN',
    scheduleEmpty: 'Noch kein Tagesplan',
    scheduleEmptySub: 'Erstell einen Trip im Planen-Tab, um deinen Tag-f\u00fcr-Tag-Plan hier zu sehen.',
    nearestEmbassy: 'N\u00e4chste Botschaft',
    usEmbassyLabel: 'US-Botschaft \u2014 {{city}}',
    hospitalsLabel: 'Krankenh\u00e4user',
    pharmacyLabel: 'Apotheke',
    erCostLabel: 'Notaufnahme ohne Versicherung: {{range}}',
    whereToGoLabel: 'Wohin gehen',
    travelAdvisory: 'Reisewarnung',
    tapWaterSafe: 'Trinkwasser geeignet',
    tapWaterUnsafe: 'Nicht trinken',
    visaNotRequired: 'Kein Visum erforderlich',
    visaOnArrival: 'Visum bei Einreise',
    visaRequired: 'Visum erforderlich',
    stayUpTo: 'Aufenthalt bis zu {{count}} Tagen',
    applicationFee: 'Geb\u00fchr: ${{cost}}',
    policeLabel: 'Polizei',
    ambulanceLabel: 'Rettungsdienst',
    fireLabel: 'Feuerwehr',
    otcAvailable: 'Frei verk\u00e4uflich',
    rxRequired: 'Rezeptpflichtig',
    insuranceCritical: 'Unverzichtbar',
    insuranceRecommended: 'Empfohlen',
    insuranceNiceToHave: 'Optional',
    insurancePrefix: 'Versicherung:',
    crimeIndex: 'Kriminalit\u00e4tsindex',
    healthRisk: 'Gesundheitsrisiko',
    politicalStability: 'Politische Stabilit\u00e4t',
    validPassport: 'G\u00fcltiger Reisepass (6+ Monate)',
    returnTicket: 'R\u00fcckflugticket',
    proofAccommodation: 'Unterkunftsnachweis',
    bankNotify: 'Bank vor der Reise informieren, um Kartensperrungen zu vermeiden',
    carrySmallBills: 'Kleingeld f\u00fcr Streetfood und Taxis mitnehmen',
    noForeignFeeCards: 'Karten ohne Auslandseb\u00fchren nutzen',
    localTime: 'Ortszeit',
  },
