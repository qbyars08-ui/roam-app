...
const de: TranslationKeys = {
  ...
  generate: {
    ...
    noTrips: 'Noch keine Trips.',
    noTripsSub: 'W\u00e4hl irgendwo. 30 Sekunden. Du hast einen kompletten Plan, bevor dich jemand herausredet.',
    howToPlan: 'Wie willst du planen?',
