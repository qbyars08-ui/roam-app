...
- **supabase/functions/weather-intel, voice-proxy**: `Access-Control-Allow-Origin: "*"` — Permissive CORS. — Restrict to app origins (tryroam.netlify.app, roamtravel.app, localhost) like claude-proxy.
