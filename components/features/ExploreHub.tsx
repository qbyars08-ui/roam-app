...
const FEATURES: Feature[] = [
  { id: 'chat', icon: 'MessageSquare', name: 'Ask AI', description: 'Chat with your travel assistant', route: '/(tabs)/plan' },
  ...
  { id: 'local-lens', icon: 'Search', name: 'Local Lens', description: 'See destinations like a local', route: '/(tabs)/plan' },
  ...
  { id: 'honest-reviews', icon: 'Star', name: 'Honest Reviews', description: 'Real traveler feedback', route: '/(tabs)/plan' },
